        ...
        <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b text-sm py-2.5 sm:py-4 dark:bg-slate-900 dark:border-gray-700">
            <nav className="max-w-7xl flex justify-between items-center w-full mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mr-5 md:mr-8">
                    <Link className="flex-none text-xl font-semibold dark:text-white" to="/">PolymerFront</Link>
                </div>
                <div className="flex flex-row items-center gap-5">
                    <ThemeToggler theme={theme} changeTheme={changeTheme}></ThemeToggler>
                    <Link to="/auth/login" className="py-2 px-3 inline-flex justify-center items-center rounded-md border-2 border-indigo-200 font-semibold text-indigo-500 hover:text-white hover:bg-indigo-500 hover:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all text-sm dark:border-indigo-700 dark:hover:border-indigo-500 dark:focus:ring-offset-indigo-800">Login</Link>
                    <Link to="/auth/signup" className="py-2 px-3 inline-flex justify-center items-center rounded-md border border-transparent font-semibold bg-indigo-500 text-white hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-indigo-800">Sign Up</Link>
                </div>
            </nav>
        </header>
        <main id="content" role="main" className='bg-white dark:bg-slate-900 min-h-screen'>
            {children}
        </main>
